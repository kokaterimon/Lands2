namespace Lands2.Services
{
    ...
    public class ApiService
    {
        public async Task<Response> CheckConnection()
        {
            if (!CrossConnectivity.Current.IsConnected)
            {
                ...
                {
                    IsSuccess = false,
                    Message = "Pleas turn on your internet settings.",
                };
            }
        ...
        public async Task<Response> Get<T>( //devuelve uno de lo que sea,
                                            //en este caso devuelve un objeto (país)
            string urlBase,
    ...
    //string accessToken  //estos dos parámetros son los únicos que no necesito para que no sea seguro
        ...
        public async Task<Response> Post<T>( //para crear un nuevo país
            string urlBase,
            string servicePrefix,
            string controller,
            string tokenType,
