namespace Lands.Backend.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Lands.Backend.Models.LocalDataContext>
    {
        public Configuration()
        {
            ...
            AutomaticMigrationDataLossAllowed = true; //br: si, por ejemplo, queremos guardar un dato de 50 caracteres en un campo que soporta solo 30, trunca los datos y lo guarda sí o sí
